...
| `screenshots/access-control/01-over-permission-page.png`     | 水平越权测试页面             |

| `screenshots/access-control/02-horizontal-login-user-a.png`  | 普通用户 lucy 登录         |

| `screenshots/access-control/03-horizontal-user-a-info.png`   | 查看 lucy 自己的信息        |

| `screenshots/access-control/04-horizontal-change-userid.png` | 修改 username 参数为 lili |

| `screenshots/access-control/05-horizontal-user-b-info.png`   | 成功查看 lili 信息         |

| `screenshots/access-control/06-burp-horizontal-request.png`  | Burp 抓取水平越权请求        |
