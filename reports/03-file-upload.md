...
| 截图                                                    | 说明                  |
| ----------------------------------------------------- | ------------------- |
| [01-upload-page](../screenshots/file-upload/01-upload-page.png)          | 文件上传功能页面            |
| [02-test-file-content](../screenshots/file-upload/02-test-file-content.png)    | 无害 PHP 测试文件内容       |
| [03-upload-success](../screenshots/file-upload/03-upload-success.png)       | PHP 文件上传成功          |
| [04-access-uploaded-file](../screenshots/file-upload/04-access-uploaded-file.png) | 访问上传文件并执行成功         |
| [05-burp-upload-request](../screenshots/file-upload/05-burp-upload-request.png)  | Burp 抓取上传请求         |
| [06-impossible-compare](../screenshots/file-upload/06-impossible-compare.png)   | Impossible 模式下上传被拦截 |
