...
| `screenshots/command-injection/01-command-page.png`             | 命令执行测试页面            |

| `screenshots/command-injection/02-normal-ping.png`              | 正常 ping 测试结果        |

| `screenshots/command-injection/03-command-injection-result.png` | 命令执行漏洞触发结果          |

| `screenshots/command-injection/04-burp-command-request.png`     | Burp 抓取命令执行请求       |

| `screenshots/command-injection/05-impossible-compare.png`       | Impossible 模式下输入被拦截 |
