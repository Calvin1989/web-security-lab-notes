...
| 截图                                                  | 说明                      |
| --------------------------------------------------- | ----------------------- |
| [01-reflected-page](../screenshots/xss/01-reflected-page.png)             | 反射型 XSS 测试页面            |
| [02-reflected-normal-input](../screenshots/xss/02-reflected-normal-input.png)     | 反射型 XSS 正常输入回显          |
| [03-reflected-xss-alert](../screenshots/xss/03-reflected-xss-alert.png)        | 反射型 XSS 弹窗验证            |
| [04-burp-reflected-xss-request](../screenshots/xss/04-burp-reflected-xss-request.png) | Burp 抓取反射型 XSS 请求       |
| [05-impossible-compare](../screenshots/xss/05-impossible-compare.png)         | 反射型 XSS Impossible 模式对比 |
| [06-stored-page](../screenshots/xss/06-stored-page.png)                | 存储型 XSS 测试页面            |
| [07-stored-normal-message](../screenshots/xss/07-stored-normal-message.png)      | 存储型 XSS 正常留言            |
| [08-stored-xss-submit](../screenshots/xss/08-stored-xss-submit.png)          | 存储型 XSS 提交后弹窗           |
| [09-stored-xss-alert](../screenshots/xss/09-stored-xss-alert.png)           | 存储型 XSS 刷新后仍然触发         |
| [10-burp-stored-xss-request](../screenshots/xss/10-burp-stored-xss-request.png)    | Burp 抓取存储型 XSS 提交请求     |
| [11-stored-impossible-compare](../screenshots/xss/11-stored-impossible-compare.png)  | 存储型 XSS Impossible 模式对比 |
