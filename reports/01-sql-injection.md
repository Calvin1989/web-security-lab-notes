...
| 截图                                                     | 说明                 |
| ------------------------------------------------------ | ------------------ |
| [01-sql-injection-page](../screenshots/sql-injection/01-sql-injection-page.png)  | SQL Injection 功能页面 |
| [02-normal-query](../screenshots/sql-injection/02-normal-query.png)        | 正常查询结果             |
| [03-error-based-test](../screenshots/sql-injection/03-error-based-test.png)    | 异常输入导致 SQL 报错      |
| [04-sqli-result](../screenshots/sql-injection/04-sqli-result.png)         | SQL 注入触发结果         |
| [05-burp-normal-request](../screenshots/sql-injection/05-burp-normal-request.png) | Burp 正常请求          |
| [06-burp-sqli-request](../screenshots/sql-injection/06-burp-sqli-request.png)   | Burp 注入测试请求        |
| [07-impossible-compare](../screenshots/sql-injection/07-impossible-compare.png)  | Impossible 模式安全对比  |
