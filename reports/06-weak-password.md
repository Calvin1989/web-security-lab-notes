...
| `screenshots/weak-password/01-brute-force-page.png`       | Brute Force 登录测试页面 |

| `screenshots/weak-password/02-wrong-password-result.png`  | 错误密码登录失败           |

| `screenshots/weak-password/03-success-login-result.png`   | 默认弱口令登录成功          |

| `screenshots/weak-password/04-burp-login-request.png`     | Burp 抓取登录请求        |

| `screenshots/weak-password/05-repeater-password-test.png` | Repeater 手工重放测试    |

| `screenshots/weak-password/06-impossible-compare.png`     | Impossible 模式安全对比  |
