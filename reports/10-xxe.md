...
C:/data/phpstudy_pro/WWW/pikachu/xxe-test.txt
...
| 截图                                               | 说明             |
| ------------------------------------------------ | -------------- |
| [01-xxe-page](../screenshots/xxe/01-xxe-page.png)             | XXE 测试页面       |
| [02-normal-xml-result](../screenshots/xxe/02-normal-xml-result.png)    | 正常 XML 解析结果    |
| [03-xxe-file-read-result](../screenshots/xxe/03-xxe-file-read-result.png) | XXE 读取无害测试文件成功 |
| [04-burp-xxe-request](../screenshots/xxe/04-burp-xxe-request.png)     | Burp 抓取 XXE 请求 |
