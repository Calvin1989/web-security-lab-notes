...
screenshots/directory-traversal/01-file-inclusion-page.png
...
screenshots/directory-traversal/02-normal-file-include.png
...
screenshots/directory-traversal/03-proof-file-content.png
...
screenshots/directory-traversal/04-directory-traversal-result.png
...
screenshots/directory-traversal/05-burp-traversal-request.png
...
screenshots/directory-traversal/06-impossible-compare.png
...
| `screenshots/directory-traversal/01-file-inclusion-page.png`        | File Inclusion 测试页面 |

| `screenshots/directory-traversal/02-normal-file-include.png`        | 正常加载 file1.php      |

| `screenshots/directory-traversal/03-proof-file-content.png`         | 无害测试文件内容            |

| `screenshots/directory-traversal/04-directory-traversal-result.png` | 目录遍历读取测试文件成功        |

| `screenshots/directory-traversal/05-burp-traversal-request.png`     | Burp 抓取目录遍历请求       |

| `screenshots/directory-traversal/06-impossible-compare.png`         | Impossible 模式安全对比   |
