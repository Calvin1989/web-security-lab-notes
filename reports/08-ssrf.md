...
`../screenshots/ssrf/01-ssrf-page.png`
...
`../screenshots/ssrf/02-normal-url-request.png`
...
`../screenshots/ssrf/03-localhost-url-input.png`
...
`../screenshots/ssrf/04-ssrf-localhost-result.png`
...
`../screenshots/ssrf/05-burp-ssrf-request.png`
