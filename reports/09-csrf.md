...
http://127.0.0.1/pikachu/vul/csrf/csrfget/csrf\_get\_edit.php?sex=boy\&phonenum=19999999999\&add=csrf\_attack\_test\&email=csrf@test.com\&submit=submit
...
GET /pikachu/vul/csrf/csrfget/csrf\_get\_edit.php?sex=boy\&phonenum=19999999999\&add=csrf\_attack\_test\&email=csrf@test.com\&submit=submit HTTP/1.1
...
| `../screenshots/csrf/01-csrf-page.png`           | CSRF(get) 测试页面    |

| `../screenshots/csrf/02-normal-profile-page.png` | 登录后用户资料页面         |

| `../screenshots/csrf/05-csrf-success-result.png` | 访问构造请求后资料被修改      |

| `../screenshots/csrf/06-burp-csrf-request.png`   | Burp 抓取 CSRF 修改请求 |

| `../screenshots/csrf/07-token-compare.png`       | CSRF Token 防护模块对比 |
